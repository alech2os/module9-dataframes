...
teams.played.against <- husky.games.2015$opponent
print(teams.played.against)
...
game.with.most.comined.yards <- husky.scores[combined.yards == max(combined.yards)] 
print(game.with.most.comined.yards)
